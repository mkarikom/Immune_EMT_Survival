...
mkdir(plotdir);
rootdir = [plotdir,'lineplots_fixFlatP_ConstBasicWorking_v3_' num2str(nGrid) '_'];
...
%% run additive model
rootdir = [plotdir,'lineplots_fixFlatP_ConstBasicWorking_v3_ADDITIVE_' num2str(nGrid) '_'];
addpath(genpath('./export_fig'));
