...
primarygenes = {'TGFBR2','ZEB1'};
secondarygenes = {'TGFBR2','ZEB1'};
...
mkdir(plotdir);
rootdir = [plotdir,'lineplots_FullData_' num2str(nGrid) '_'];
...
%% run additive model
rootdir = [plotdir,'lineplots_FullData_ADDITIVE_' num2str(nGrid) '_'];
addpath(genpath('./export_fig'));
