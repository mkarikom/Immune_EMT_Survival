...
% sampling
mycantypes = [1,3];
nk = .01; % nk * 1000 = the number of models to fit
n_boot = nk*1000; 
n_sub = 100; % the number of resampled patients per n_boot model fit
nstd = 0.2; % the nstd * standard deviation of gene n * rand(1) + gene n = the level of gene n when doing resampling
% priors
msiginit = 1e-9;
maglinit = 1e-9;
...
dirname = ['./DataTables/bootstrap_Both_WithParfor_' num2str(nk) 'k_',num2str(n_sub),'n/'];
