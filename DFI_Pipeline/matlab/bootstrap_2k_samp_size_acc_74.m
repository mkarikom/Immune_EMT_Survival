...
maxfevals = 1000;
mycantypes = [1,3];
nstd = 0.1; % the nstd * standard deviation of gene n * rand(1) + gene n = the level of gene n when doing resampling

if ~isdeployed
    addpath("../DataTables/")
end
dirname = ['./DataTables/resampling_IG_G_Replacement_Keep_' num2str(nk) 'k_',num2str(fixedresample),'n/'];
